...
var StdProvisioningComponent = (function () {
    function StdProvisioningComponent(_demoService, http) {
        this._demoService = _demoService;
        this.http = http;
        this.title = 'Reason user UX';
    ...
    //HELPERS
    StdProvisioningComponent.prototype.getTimeStamp = function () {
        return new Date().toDateString() + " " + new Date().toTimeString();
    };
    //---------------------------------------------------------------------------------------------------------
    StdProvisioningComponent.prototype.reloadPage = function () {
        location.reload();
    };
    //FeedbackRequest button click---------------------------------------------------------------------------------------------------------
    StdProvisioningComponent.prototype.sendFeedbackRequest = function (formValue) {
    ...
    StdProvisioningComponent.prototype.checkResults = function (data) {
        alert(data.status);
    };
    //Submit button click---------------------------------------------------------------------------------------------------------
    StdProvisioningComponent.prototype.sendRequest = function (formValue) {
        var _this = this;
        //clear any vars
        this.displayOutputDiv = false;
        this.displayLogDiv = false;
    ...
    //----------------------------------------------------------------------------------------------------------------------------
    StdProvisioningComponent.prototype.doPost = function () {
        var _this = this;
    ...
    //MESSGA EFORMATTING------------------------------------------------------------------------------------------------
    StdProvisioningComponent.prototype.setMessage = function (TheMessage, MessageType) {
        if (MessageType == "s") {
    ...
    //setFeedbackMessage------------------------------------------------------------------------------------------------
    StdProvisioningComponent.prototype.setFeedbackMessage = function (TheMessage, MessageType) {
    ...
    StdProvisioningComponent.prototype.IsJsonString = function (str) {
        try {
            JSON.parse(str);
        }
        catch (e) {
    ...
    // }
    //STATUS POLL----------------------------------------------------------------------------------------------------------------------------
    StdProvisioningComponent.prototype.startPolling = function () {
        var _this = this;
    ...
    //----------------------------------------------------------------------------------------------------------------------------
    StdProvisioningComponent.prototype.doStatusCheck = function (data) {
        var _this = this;
    ...
    StdProvisioningComponent.prototype.convertToArr = function (Input) {
    ...
    StdProvisioningComponent = __decorate([
        core_1.Component({
    ...
    ], StdProvisioningComponent);
    return StdProvisioningComponent;
}());
exports.StdProvisioningComponent = StdProvisioningComponent;
...
//   destroyed
// } 
//# sourceMappingURL=stdprovisioning.component.js.map