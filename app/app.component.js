...
var AppComponent = (function () {
    ...
    AppComponent.prototype.sendFeedbackRequest = function (formValue) {
    ...
    AppComponent.prototype.checkResults = function (data) {
        alert(data.status);
    };
    //Submit button click---------------------------------------------------------------------------------------------------------
    AppComponent.prototype.sendRequest = function (formValue) {
        var _this = this;
        //clear any vars
        this.displayOutputDiv = false;
        this.displayLogDiv = false;
    ...
    //MESSGA EFORMATTING------------------------------------------------------------------------------------------------
    AppComponent.prototype.setMessage = function (TheMessage, MessageType) {
        if (MessageType == "s") {
    ...
    // }
    //STATUS POLL----------------------------------------------------------------------------------------------------------------------------
    AppComponent.prototype.startPolling = function () {
        var _this = this;
    ...
    //----------------------------------------------------------------------------------------------------------------------------
    AppComponent.prototype.doStatusCheck = function (data) {
        var _this = this;
    ...
    AppComponent.prototype.convertToArr = function (Input) {
